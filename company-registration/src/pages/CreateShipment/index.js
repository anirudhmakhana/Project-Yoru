            ...
            <div style={{width:'82vw', height:'50vh'}}>
               ...
               {originNode && nodeStock ? (
                ...
                <div>
                    ...
                    <p style={{color:"#000000"}}>Company: {originNode.companyCode}</p>
                    <p style={{color:"#000000"}}>Address: {originNode.address}</p>
                    <p style={{color:"#000000"}}>Contact: {originNode.phoneNumber}</p>
